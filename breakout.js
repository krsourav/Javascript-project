            ...
            if (b.status == 1) {
                if ((circleX > b.x) && (circleX < b.x + brickWidth) &&
                    ...
                    if (score == (brickColumnCount * brickRowCount)) {
                        ...
                        alert("Congratulations You Win. click Start to play again. ");
...
function drawCircle() {
    ...
    if (circleY - radius < 0 || circleY + radius > paddleY &&
        (circleX + radius < paddleX + paddleWidth || circleX - radius < paddleX + paddleWidth) &&
...
function draw() {
    ...
    if (circleY + radius > canvas.height) {
        ...
        alert("Game Over. Your Score is:" + " " + score + ".Click 'Start' to Play Again");
        window.location.reload();
        toggleInterval();
    }
